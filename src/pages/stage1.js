	...
	return <Theme theme={theme}>
		...
		>
			...
			<Box width="730px" height="230px" display="flex">
				<Box display="flex" width="210px" height="230px">
					<Text
						height="207px"
						position="relative"
				...
				<Box display="flex" width="210px" height="230px" margin="0px 0px 0px 48px">
					<Text
						height="207px"
						position="relative"
						align-self="flex-start"
				...
				<Box display="flex" width="210px" height="230px" margin="0px 0px 0px 40px">
					<Text
						height="207px"
						position="relative"
						align-self="flex-start"
